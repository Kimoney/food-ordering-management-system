        ...
        <div className="mx-auto mt-[107px] flex w-full max-w-[1086px] items-center md:flex-col md:p-5">
          ...
          <div className="flex flex-1 flex-col items-start gap-7 bg-white-A700 p-10 md:self-stretch sm:p-5">
            ...
            <div className="flex flex-col items-start gap-[5px]">
                ...
                <Input shape="round" type="Full Name" name=" Full Name" placeholder={`Full Name`} className="sm:pr-5" />
              </div>
              <div className="flex flex-col items-start gap-[5px]">
                <Text as="p" className="!text-gray-800">
                  Username
              ...
              <Button color="deep_orange_600" shape="round" className="w-full !rounded-[10px] sm:px-5" onClick={handleSubmit}>
                Submit
              </Button>
            </div>
            </form>
